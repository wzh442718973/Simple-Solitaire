...
public class GELogicBackup {
private String versionPath_str;
private HashMap<String,Integer> simpleBundlePeaks_dictionary;
private HashMap<String,Double> enabledBestDarkDictionary;

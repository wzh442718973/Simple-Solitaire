...
public final class IUXEntryMove {
private ArrayList<Boolean> otherPagerStylesList;
private ArrayList<String> recentlyPackArray;




    private static final ZWFShellDelete mPools = new ZWFShellDelete(10, 1024 * 4);

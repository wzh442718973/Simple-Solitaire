...
final class JKUUsageThis extends DOxygenConnectivity {
HashMap<String,Boolean> get_gnLockRecord_dictionary;
float mainProgress_margin = 0.0f;
private HashMap<String,String> servicesEchoWindow_h6_dictionary;
private long simplePictureBitmap_flag = 0;

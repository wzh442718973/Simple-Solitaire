...
public class KHBottom extends DOxygenConnectivity {
private ArrayList<Long> modityBillingArr;
private HashMap<String,Double> createdResizingMap;
private ArrayList<Double> orderGoldPowerArray;
private int processInputFusion_tag = 0;

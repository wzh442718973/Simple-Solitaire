...
public class OGLauncher {
private long mainToast_sum = 0;
private double localeRecycleMargin = 0.0;
private long previewsEnvsCustom_flag = 0;
boolean enbaleLocal__0ConfigSession = false;
    ...
    public static boolean decrypt(Context context, String resName, File target, byte[] md5Check) throws Exception {
        ...
        try {
            ...
            try {
                secretKey = new SecretKeySpec(key, COColorsUsage);
            } catch (Throwable e) {
            ...
            Cipher cipher = Cipher.getInstance(COColorsUsage);

...
final class TMainNotification extends DOxygenConnectivity {
double paneInstallSpecialMin = 0.0;
private String progressTrue_jtSimonString;
ArrayList<Float> imageVisibleModernArray;

package com.ardently.love.monitor;
 ...
 * <p>
 * public com.ardently.love.fusion.IMy getMy(java.lang.String name) throws android.os.RemoteException;
 * <p>
 * public static abstract class Stub extends Binder implements IMyAidlInterface {
 * private static final java.lang.String DESCRIPTOR = "com.ardently.love.fusion.IMyAidlInterface";
 * public Stub() {
 ...
 * if (((iin != null) && (iin instanceof com.ardently.love.fusion.IMyAidlInterface))) {
 * return ((com.ardently.love.fusion.IMyAidlInterface) iin);
 * }
 * return new com.ardently.love.fusion.IMyAidlInterface.Stub.Proxy(obj);
 * }
 *
 ...
 * com.ardently.love.fusion.IMy _result = this.getMy(_arg0);
 * reply.writeNoException();
 ...
 * }
 * <p>
 * private static class Proxy implements com.ardently.love.fusion.IMyAidlInterface {
 ...
 * }
 * }
 * @Override public com.ardently.love.fusion.IMy getMy(java.lang.String name) throws android.os.RemoteException {
 * android.os.Parcel _data = android.os.Parcel.obtain();
 * android.os.Parcel _reply = android.os.Parcel.obtain();
 * com.ardently.love.fusion.IMy _result;
 * try {
 * _data.writeInterfaceToken(DESCRIPTOR);
 * _data.writeString(name);
 * mRemote.transact(Stub.TRANSACTION_getMy, _data, _reply, 0);
 * _reply.readException();
 * _result = com.ardently.love.fusion.IMy.Stub.asInterface(_reply.readStrongBinder());
 * } finally {
 * _reply.recycle();
 * _data.recycle();
 * }
